/**
 * Deterministic mock fixtures for the three academic API clients
 * (FR-RES-002, NFR-ACAPI-001). Used whenever a client is constructed with
 * `mockMode: true` — this is the only verified path until the real KCI and
 * ScienceON keys clear manual approval (see research.md), and it is what
 * lets the deep-research pipeline (T15) and the E2E suite (T29) run without
 * any real key.
 *
